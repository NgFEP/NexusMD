...
namespace Cuda {
    ...
    class Exclusions {
    public:
        //static void createExclusions(std::size_t& numParticles, std::vector<BondParams>& bonds, std::vector<AngleParams>& angles, std::vector<PTorsionParams>& torsions, std::vector<std::set<int>>& exclusions, int& bondCutoff);
