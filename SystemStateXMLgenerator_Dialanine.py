...
with open('system_dialanine.xml', 'w') as system_file:
...
with open('state_dialanine.xml', 'w') as state_file:
    xml = XmlSerializer.serialize(state)
    state_file.write(xml)

print("System and initial state serialized to system_dialanine.xml and state_dialanine.xml respectively.")