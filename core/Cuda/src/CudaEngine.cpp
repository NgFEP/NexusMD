...
Engine::Engine(
    ...
    bool harmonicBondForceEnabled,
    bool harmonicAngleForceEnabled,
    bool periodicTorsionForceEnabled,
    bool nonbondedForceEnabled
...
void Engine::CalculateForces() {
    ...
    if (_harmonicBondForceEnabled) {
        //cout << "Harmonic_Bond_Force is enabled" << endl;
        // Harmonic_Bond_Force is enabled
