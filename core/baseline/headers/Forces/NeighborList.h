...
namespace BaseLine {
    ...
    // Define a type alias for a vector of pairs, representing a voxel
    ...
    //struct VoxelIndex {
    //    VoxelIndex(int x, int y, int z) : x(x), y(y), z(z) {} // Ensure constructor is available
    ...
    private:
        ...
        const PeriodicBoundaryCondition::BoxInfo _boxInfo; // Corrected spelling and consistency
        int nx, ny, nz;
