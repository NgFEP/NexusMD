...
//using namespace std;
//
//void Reporter::report(const string& filename, const vector<Coords3D>& positions, const vector<Coords3D>& velocities, const vector<Coords3D>& forces, int step, bool clearFile) {
