...
struct AngleParams {// AngleParams HarmonicAngleParams
...
public:
    ...
    // Parses the system.xml file and returns a vector of BondParams structure
    static std::vector<BondParams> HBondParser(const std::string& filename);

    // Parses the system.xml file and returns a vector of AngleParams structure
    static std::vector<AngleParams> HAngleParser(const std::string& filename);
