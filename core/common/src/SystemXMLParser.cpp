...
vector<PTorsionParams> SystemXMLParser::PTorsionParser(const string& filename) {
    ...
    // To navigate to the <Force> elements and check for the type attribute to be "PeriodicTorsionForce"
...
vector<BondParams> SystemXMLParser::HBondParser(const string& filename) {
    ...
    // To navigate to the <Force> elements and check for the type attribute to be "HarmonicBondForce"
    for (auto& force : doc.child("System").child("Forces").children("Force")) {
        string forceType = force.attribute("type").as_string();
...
vector<AngleParams> SystemXMLParser::HAngleParser(const string& filename) {
    ...
    // To navigate to the <Force> elements and check for the type attribute to be "HarmonicAngleForce"
    for (auto& force : doc.child("System").child("Forces").children("Force")) {
        string forceType = force.attribute("type").as_string();
